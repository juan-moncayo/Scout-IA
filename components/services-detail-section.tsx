            ...
            return (
              <Button
                ...
                className={`flex items-center gap-2 text-sm transition-all ${
                  activeService === s.id ? "bg-red-600 text-white hover:bg-red-700" : "border-gray-600 text-gray-600 hover:bg-gray-800 hover:text-white"
                }`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="flex gap-4 mt-6">
                <Link href="/contact">
                  <Button className="bg-red-600 hover:bg-red-700 text-white">
                    {t.getEstimate} <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                </Link>
            ...
            <div>
              <div className="relative overflow-hidden rounded-lg shadow-2xl">
                <img src={currentService.image} alt={currentService.title} className="w-full h-72 object-cover" />
